...
if($_SESSION['user_partner'] && is_numeric($_GET['id']) && !empty($_GET['path'])){
	...
	$string="<select name='jobs[articleType_fk]' style='width:500px' onChange='return showArticleTypePrice(\"".$_GET['path']."\", this.value)' ><option value='0'>Izaberite tip artikla</option>\n";
