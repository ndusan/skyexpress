...
<head>
	...
	<link rel="shortcut icon" href="<?php echo APP_ROOT. 'public/img/favicon.ico'?>" >
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta http-equiv="Content-Language" content="en" />
	<meta name="GENERATOR" content="PHPEclipse 1.2.0" />
		
	<link type="text/css" rel="stylesheet" href="<?php echo APP_ROOT.'public/stylesheets/default.css'?>">
	<link type="text/css" rel="stylesheet" href="<?php echo APP_ROOT.'public/stylesheets/admins.css'?>">
	
	<script type="text/javascript" src="<?php echo APP_ROOT.'public/ajax/default.js'?>"></script>
	
	<script type="text/javascript" src="<?php echo APP_ROOT.'public/js/default.js'?>"></script>
	<script type="text/javascript" src="<?php echo APP_ROOT.'public/js/admins.js'?>"></script>
	
	<script type="text/javascript" src="<?php echo APP_ROOT.'public/js/divDateDropDown.js'?>"></script>
	<!--  This is hardcore -->
	<?php
	if($route['submenu'] != 'specific_article'){
	?>
