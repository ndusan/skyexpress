	...
	<div class="entry-asset asset hentry news">
		<?php
		 if(($page - 1) <= $total_pages && $page !=1): ?>
		  ...
		  <a href="<?php echo APP_ROOT; ?>tickets/page/<?php echo $page - 1; ?>"><img src="<?php echo APP_ROOT.'public/img/prev.gif'?>" title="Prethodna stranica"/></a>
		...
		<?php if(($page + 1) <= $total_pages): ?>
		  ...
		  <a href="<?php echo APP_ROOT; ?>tickets/page/<?php echo $page + 1; ?>"><img src="<?php echo APP_ROOT.'public/img/next.gif'?>" title="Sledeca stranica"/></a>
