...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <th valign="top" background="img/images/bg_top-pozadina.jpg" scope="col"><table width="794" border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="left" valign="bottom"><table width="794" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <th scope="col"><img src="img/images/btn_usluge_active.jpg" width="122" height="45" border="0" /></th>
          ...
          <tr>
            <td width="569" valign="top" class="naslov" id="podmenu" scope="col"><span class="podnaslov"><br />
              ...
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="left"><p align="left" class="naslov_text">Usluge</p>
                    <p align="left" class="podnaslov">Stranica je u pripremi<img src="img/usluge.jpg" width="202" height="156" align="right" /></p>
                    <p class="text">Posetite nas ponovo.</p>
                    <p class="text">&nbsp;</p>
                    <p class="text">&nbsp;</p>
                    </td>
                </tr>
