...
<body onload="MM_preloadImages('img/images/btn_home_ac.jpg','img/images/btn_aboutus_ac.jpg','img/images/btn_job_ac.jpg','img/images/btn_contact_ac.jpg','img/images/btn_english_ac.jpg')"> 
      ...
      <tr>
        <th scope="col"><table width="793" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <th width="77" scope="col"><img src="img/images/btn_ref_ac.jpg" alt="Reference" width="76" height="44" border="0" /></th>
          ...
          <tr>
            <td width="569" valign="top" class="naslov" id="podmenu" scope="col"><span class="podnaslov"><br />
              ...
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td><p align="left" class="naslov_text">Referentna lista</p>
                    <p align="left" class="podnaslov">Stranica je u pripremi</p>
                    <p align="left" class="podnaslov">&nbsp;</p>
                    <p align="left" class="podnaslov">&nbsp;</p>
                    <p align="left" class="podnaslov">&nbsp;</p>
                    <p class="text">&nbsp;</p></td>
                </tr>
