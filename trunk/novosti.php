...
<body onload="MM_preloadImages('img/images/btn_home_ac.jpg','img/images/btn_aboutus_ac.jpg','img/images/btn_ref_ac.jpg','img/images/btn_job_ac.jpg','img/images/btn_contact_ac.jpg','img/images/btn_english_ac.jpg','img/images/btn_proizvodi_active.jpg')"> 
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <th valign="top" background="img/images/bg_top-pozadina.jpg" scope="col"><table width="794" border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="left" valign="bottom"><table width="794" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th scope="col"><a href="proizvodi.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image14','','img/images/btn_proizvodi_active.jpg',1)"><img src="img/images/btn_proizvodi_inactive.jpg" name="Image14" width="149" height="45" border="0" id="Image14" /></a></th> 
            <th scope="col"><a href="usluge.php"><img src="img/images/btn_usluge_inactive.jpg" alt="Usluge" width="122" height="45" border="0" /></a></th>
            <th scope="col"><a href="tehnicka-podrska.php"><img src="img/images/btn_support-Inactive.jpg" width="122" height="45" border="0" /></a></th>
            <th scope="col"><a href="preuzimanje.php"><img src="img/images/btn_download_inactive.jpg" width="122" height="45" border="0" /></a></th>
            <th scope="col"><a href="partneri.php"><img src="img/images/btn_partners_inactive.jpg" width="122" height="45" border="0" /></a></th>
            <th scope="col"><a href="novosti.php"><img src="img/images/btn_news_active.jpg" width="157" height="45" border="0" /></a></th>
          </tr>
        </table></td>
      </tr>
    </table></th>
  ...
  <tr>
    ...
    <td width="794" bgcolor="#EFEFEF"><table width="794" border="0" cellpadding="0" cellspacing="0" background="img/images/bg_main.jpg">
      <tr>
        <th width="794" align="center" valign="top" scope="col"><div align="center">
          <script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','767','height','123','src','img/headerse','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','img/headerse' ); //end AC code
      ...
      <tr>
        <th scope="col"><table width="794" height="263" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="568" height="263" valign="top" class="naslov" id="podmenu" scope="col">
                <span class="podnaslov"><br />
              </span>
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td valign="top"><p align="left" class="naslov_text">Novosti<br />
                    <br />
                  </p>
                    </td>
                </tr>
                <tr>
                  <td valign="top">
                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        if(is_numeric($_GET['news'])) $sql .= " and id=$_GET[news] ";
                        $sql   .= " order by id desc";
                        $res = mysql_query($sql);
                        while($result = mysql_fetch_assoc($res)){
                        ?>
                        <tr>
                            <td width="22%" valign="top"><div id="datum-novosti"><?php echo dateFormat($result['date'])?></div></td>
                            <td width="78%" valign="top"><div id="naslov-vesti">
                              <a href="<?php echo $_SERVER['PHP_SELF']?>?news=<?php echo $result['id']?>" ><?php echo $result['title']?></a>
                            </div>
<div align="justify" id="text-vesti">
                                <?php
                            if($result['id'] && $_GET['news']){
              ...
              <tr>
                <th align="right" scope="col"><div align="right"><img src="img/images/Sky_Express_logo.jpg" width="141" height="97" /></div></th>
                </tr>
              <tr>
                <td height="40" align="right">                  <div align="right">Rudnička 9,
                  Beograd<br />
                  011 2421 580, 2421 945<br />                    
                </div></td>
                </tr>
              <tr>
                <td align="right"><div align="right"><a href="mailto:prodaja@sky-express.rs">prodaja@sky-express.rs</a></div></td>
                </tr>
              <tr>
                <td align="right"><div align="right"><a href="mailto:podrska@sky-express.rs">podrska@sky-express.rs</a></div></td>
                </tr>
              <tr>
                <td align="right"><div align="right"><a href="index.html">www.sky-express.rs</a></div></td>
              </tr>
              
            </table>
                <p><img src="img/partners.jpg" width="200" height="386" /><br />
                <table width="199" border="0" align="left" cellpadding="0" cellspacing="0" id="brzi-naslov">
                  <tr>
                    <td height="25" align="right" bgcolor="#F3872D"><p align="right">Brzi linkovi </p></td>
                  </tr>
                  <tr>
                    <td><table width="100%" height="177" border="0" align="center" cellpadding="0" cellspacing="0" id="brzi-linkovi">
                      <tr>
                        <td width="242" height="177" align="right" valign="top"><div align="right"><a href="tehnicka-podrska.php"><br />
                          ...
                          <a href="onama.php">Informacije o nama</a></div></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></p></th>
