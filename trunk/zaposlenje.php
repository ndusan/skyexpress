...
<body onload="MM_preloadImages('img/images/btn_home_ac.jpg','img/images/btn_aboutus_ac.jpg','img/images/btn_ref_ac.jpg','img/images/btn_contact_ac.jpg','img/images/btn_english_ac.jpg')"> 
      ...
      <tr>
        <th scope="col"><table width="793" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <th width="77" scope="col"><img src="img/images/btn_job_ac.jpg" alt="Zaposlenje" width="76" height="44" /></th>
      ...
      <tr>
        <th scope="col"><table width="794" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="569" valign="top" class="naslov" id="podmenu" scope="col"><span class="podnaslov"><br />
              ...
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td><p align="left" class="naslov_text">Zaposlenje</p>
                    <p align="left" class="text">Trenutno ne postoje novi oglasi za posao.<img src="img/work.jpg" width="250" height="179" align="right" /></p>
                    <p align="left" class="text">Posetite nas ponovo.</p>
                    <p class="text">&nbsp;</p></td>
                </tr>
                <tr>
          ...
          <table width="794" border="0" align="right" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <th rowspan="2" valign="top" scope="col"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EFEFEF" id="support_download2">
                  <tr>
                ...
                <br /></th>
              <th width="225" align="left" valign="top" scope="col"><p><img src="img/partners.jpg" width="200" height="386" /></p>
