...
<body onload="MM_preloadImages('img/images/btn_home_ac.jpg','img/images/btn_ref_ac.jpg','img/images/btn_job_ac.jpg','img/images/btn_contact_ac.jpg','img/images/btn_english_ac.jpg')"> 
      ...
      <tr>
        <th scope="col"><table width="793" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <th width="77" scope="col"><img src="img/images/btn_aboutus_ac.jpg" alt="O nama" width="76" height="44" border="0" /></th>
      ...
      <tr>
        <th scope="col"><table width="794" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="569" valign="top" class="naslov" id="podmenu" scope="col"><span class="podnaslov"><br />
              ...
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td valign="top"><p align="left" class="naslov_text">O nama</p>
                    <p align="left" class="podnaslov">Sky Express d.o.o.</p>
                    <p align="left" class="podnaslov">Rudnička 9<br />
                    11000 Beograd</p>
                    <p align="left" class="podnaslov">Tel: 011 2421 580<br />
                    Fax: 011 2421 945</p>
                    <p align="left" class="podnaslov">PIB:102707059<br />
                    Matični broj: 17461109</p>
                    </td>
                </tr>
                <tr>
          ...
          <table width="794" border="0" align="right" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <th rowspan="2" valign="top" scope="col"><br />
