      ...
      <tr>
        <td align="left" valign="bottom"><table width="794" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <th scope="col"><img src="img/images/btn_support-active.jpg" width="122" height="45" border="0" /></th>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','767','height','123','src','img/headerse','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','img/headerse' ); //end AC code
      ...
      <tr>
        <th scope="col"><table width="794" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="569" valign="top" class="naslov" id="podmenu" scope="col"><span class="podnaslov"><br />
              </span>
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td><p align="left" class="naslov_text">Tehnička podrška</p>
                    <p align="left" class="podnaslov">Za korisnike kuljenog softvera</p>
                    <p align="left" class="text">Svi korisnici kupljene verzije softvera iz naše ponude imaju pravo na <strong>besplatnu tehničku podršku</strong> za vreme trajanja licence.<img src="img/support.jpg" width="112" height="112" align="right" /></p>
                    <p align="left" class="podnaslov">Za korisnike probnog softvera</p>
                    <p align="left" class="text">Svi korisnici probne verzije softvera iz naše ponude imaju pravo na besplatnu tehničku podršku za vreme trajanja probne licence (30 dana).</p>                    </td>
                </tr>
                <tr>
                  <td><div align="center"></div></td>
                </tr>
              </table>
              </td><th width="225" valign="top" scope="col"><table width="177" border="0" align="center" cellpadding="0" cellspacing="0" id="tabela_side">
              <tr>
          ...
          <table width="794" border="0" align="right" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <th valign="top" scope="col"><table width="535" border="0" align="center" cellpadding="0" cellspacing="0" id="support_download">
                <tr>
                  <th width="100%" align="left" valign="top" class="naslov_text_manji" scope="col"><ul>
                    <li class="naslov_text_manji">AVG paleta proizvoda</li>
                  </ul>
                    <p class="text"><img src="img/avg-logo.jpg" width="150" height="78" /></p>
                    <p class="text">Tehnička podrška za korisnike kupljene verzije je besplatna u periodu trajanja licence (1 ili 2 godine).<br />
                      Kako bi imali pravo na tehničku podršku potrebno je prijavu pošaljete na osnovu datog <a href="avg-tehnicka-podrska.php">upustva</a>.</p>
                    <p class="text">Sve detalje vezane za AVG tehničku podršku, možete pronači na stranici <a href="avg-tehnicka-podrska.php">AVG Tehnička podrška</a>.</p>                    </th>
                </tr>
              </table>                
                  ...
                  <tr>
                    <th width="100%" align="left" valign="top" scope="col"><ul>
                      <li class="naslov_text_manji">Kerio paleta proizvoda</li>
                      </ul>
                      <p class="text"><img src="img/kerio_signature.gif" width="225" height="39" /></p>
                      <p class="text">Tehnička podrška za korisnike kupljene verzije je besplatna u periodu trajanja licence (1godine).<br />
                        Kako bi imali pravo na tehničku podršku potrebno je prijavu pošaljete na osnovu datog <a href="kerio-tehnicka-podrska.php">upustva</a>.</p>
                      <p class="text">Sve detalje vezane za Kerio tehničku podršku, možete pronaći na stranici <a href="kerio-tehnicka-podrska.php">Kerio Tehnička podrška</a>.</p>                      </th>
                  </tr>
                </table>
                <br />
                <span class="tackice">....................................................................................................................................................................</span><br />
