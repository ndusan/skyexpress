      ...
      <tr>
        <td align="left" valign="bottom"><table width="794" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <th scope="col"><img src="img/images/btn_partners_active.jpg" alt="Partneri" width="122" height="45" border="0" /></th>
        ...
        <th scope="col"><table width="794" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="569" valign="top" class="naslov" id="podmenu" scope="col"><span class="podnaslov"><br />
              ...
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td><p align="left" class="naslov_text">Partneri</p>
                    <p align="left" class="podnaslov">Želite da postanete deo globalne distribucijske mreže za AVG i Kerio proizvode? </p>
                    <p align="left" class="text">Detalje za prijavu partnera možete nači na stranici <a href="postanite-partner.php">Postanite partner</a></p>
                    <p class="text">&nbsp;</p></td>
                </tr>
                <tr>
          ...
          <table width="794" border="0" align="right" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <th width="225" valign="top" scope="col"><img src="img/partners.jpg" width="200" height="386" /><br /><table width="199" border="0" align="left" cellpadding="0" cellspacing="0" id="brzi-naslov">
                  <tr>
