        ...
        <th scope="col"><table width="794" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table width="231" border="0" align="center" cellpadding="10" cellspacing="0" bgcolor="#EFEFEF" id="tabela_side_menu">
              <tr>
                <th scope="col"><p class="naslov_podmenu">Ostali AVG proizvodi</p>
            ...
            </table></td><th width="287" valign="top" id="product_head"><p class="naslov_text">AVG Internet Security SBS</p>
              <p class="podnaslov"><strong>Kompletna zaštita  za vašu Microsoft <br />
                Windows Small Business Server poslovnu računarsku mrežu.. <br />
                Fokusirajte se na posao i minimizujte IT troškove.</strong></p>              <ul>
                <li class="text"><strong><a href="avg-security-moduli.php#anti_virus">Anti-Virus</a>:</strong> zaštita od virusa, crva<br /> 
                  i trojanaca </li>
                  <li class="text"><strong><a href="avg-security-moduli.php#anti_spyware">Anti-Spyware</a>:</strong> zaštita od spajvera, <br />
                    advera i kradljivaca identiteta</li>
                  <li class="text"><strong>Anti-Spam: </strong>zaštita od neželjene<br /> 
                    elektronske pošte - desktop opcija</li>
                  <li class="text"><strong><a href="avg-security-moduli.php#anti_rootkit">Anti-Rootkit</a>:</strong> zaštita od skrivenih pretnji (rootkit-ova) </li>
                  <li class="text"><strong><a href="avg-security-moduli.php#web_shield">Web   Shield</a> &amp; <a href="avg-security-moduli.php#link_scanner">LinkScanner</a>:</strong> zaštita od Internet sajtova sa opasni sadržajem</li>
                  <li class="text"><strong><a href="avg-security-moduli.php#firewall">Firewall</a>:</strong> zaštita od hakera (zaštitni zid)- desktop opcija</li>
                </ul></th>
          ...
          <table width="794" border="0" align="right" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <th valign="top" scope="col"><br />
                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" id="main_tabel_karatkeristike">
                  <tr>
                    <th width="19%" align="right" valign="middle" scope="col"><img src="img/avg-box-issbs.jpg" alt="" width="75" height="105" align="middle" /></th>
                    <th width="81%" scope="col"><div align="left" id="bullet_list">
                          <ul>
                            <li>Laka za preuzimanje, instalaciju i korišćenje</li>
                            <li>Zaštita za radne stanice, file servere i email servere</li>
                            <li>Centralizovana instalacija i konfiguracija</li>
                            <li>Besplatna tehnička podrška</li>
                            <li>Zaštita od virusa, spajvera, advera, hakera i spama</li>
                            <li>Specijalno dizajnirana zaštita za Microsoft Windows Small Business Servere</li>
                          </ul>
                    </div></th>
                  </tr>
                </table>
                <span class="tackice">....................................................................................................................................................................</span><br />
                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" id="div_daljazastita">
                <tr>
                  <th align="left" scope="col"><ul>
                    <li class="naslov_text_manji">                      Zaštita Vaše poslovne mreže</li>
                  </ul>
                    <p align="left" class="text">Kombinacija novog i inteligentnog skenera u realnom vremenu, sveobuhvatnog veb štita i brzog ažuriranja baze virusa, obezbeđuju Vam sigurnost Vaših podataka.</p>
                    <p align="left" class="text"><strong>Svaka komponenta Vaše poslovne mreže je zaštićena:</strong></p>
                    <ul>
                      <li class="text"> File serveri</li>
                      <li class="text"> E-mail servari</li>
                      <li class="text"> MS Exchange serveri</li>
                      <li class="text">Share-point portali</li>
                      <li class="text"> Radne stanice</li>
                      <li class="text">Lap Top-ovi<br />
                      </li>
                    </ul></th>
                </tr>
              </table>                
                  ...
                  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" id="div_daljazastita">
                    <tr>
                      <th align="left" scope="col"><ul>
                        <li class="naslov_text_manji">                          Optimizujte Vaše IT resurse</li>
                      </ul>
                        <p align="left" class="text">AVG i svanjegova funkcionalnost mogu biti podešene u minuti. Centralni menadžment i monitoring <a href="#"></a>obezbeđuju Vam jednostavno upravljanje programom.</p>
                          <ul>
                            <li class="text"> 
                              <div align="left">Udaljena instalacija i administracija</div>
                            </li>
                            <li class="text">
                              <div align="left">Administacija licenci</div>
                            </li>
                            <li class="text">
                              <div align="left">Centralizovana konfiguracija, izveštavanje i ažuriranje<br />
                              </div>
                            </li>
                      </ul></th>
                    </tr>
                  ...
                  <tr>
                    <th align="left" valign="top" scope="col"><ul>
                      <li class="naslov_text_manji">                        Licenciranje</li>
                    </ul>
                      <p align="left" class="text">Zaštita za umrežene računare.</p>
                        <p align="left" class="text"> Licecni paketi su za  5+1, 10+1...50+1, 60+1, 70+1, 75+1...100+1..200+1... računara.<br />
                        </p>
                        <ul>
                          <li class="text">
                            <div align="left">Broj licenci se određuje ukupniom brojem radnih stanica i file servera u mreži.<br />
                              </div>
                          </li>
                          <li class="text">
                            <div align="left">1 besplatna licenca za server (E-mail ili File server)<br />
                              </div>
                          </li>
                          <li class="text">
                            <div align="left">Periodi licenciranja su 1 ili 2 godine.<br />
                              </div>
                          </li>
                          <li class="text">
                            <div align="left">Specijalni popusti za GOV i EDU ustanove.</div>
                          </li>
                      </ul>                        
                      <p align="left" class="text"><a href="avg-licenciranje.php">Šta podrazumeva Licenciranje i koji su pogodnosti licenciranog softvera?</a><br />
                        <a href="mailto:prodaja@sky-express.rs"><img src="img/order.jpg" width="308" height="47" border="0" /></a></p></th>
</tr>
                              </table>
                <span class="tackice">....................................................................................................................................................................</span><br />
                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <th align="left" valign="top" scope="col"><ul>
                        ...
                        <p align="left" class="text">Windows  2000 SP4/ XP SP 2 (32/64 bit) / Vista (32/64 bit) / Vista SP1 (32/64bit)<br />
Windows Server 2000 / 2003 (32/64 bit) / 2008  (32/64 bit) / Linux / MS Share Point / MS Exchange Server 2000/2003/2007</p>
                        <p align="left" class="text"> Intel Pentium 1.2 GHz, 250 MB slobodnog prstra na  hard disku (za instalaciju) 256 MB RAM<br />
                            <br />
                          Anti-Spyware, Firewall i Web Shield su komponente samo za radne  stanice. Nije preporučljivo instalirati ih na File Servere. </p>
                        <p align="left" class="text">Anti-Rootkit komponenta nije dostupna za 64-bitne operativne sisteme. </p></th>
        </tr>
                                </table>                
                <span class="tackice">....................................................................................................................................................................</span><br />
                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" id="support_download">
                  <tr>
                    <th align="left" valign="top" scope="col"><ul>
                      <li class="naslov_text_manji">                        Tehnička podrška i preuzimanje</li>
                    </ul>                      
                    <p align="left" class="text">Svi korisnici FULL verzije (komercijalne vezije) za vreme trajanja licence imaju <a href="avg-tehnicka-podrska.php">besplatnu e-mail tehničku podršku.</a><br />
                        <br />
                        Preuzmite probnu verziju AVG Anti-Virus edicije u trajanju od 30 dana.<br />
                        Preuzmite FULL verziju za Vaš AVG proizvod.<br />
                        <a href="avg-download.php#avgissbs"><img src="img/download_trial.jpg" width="308" height="47" border="0" /></a></p>                      </th>
                  </tr>
                </table>                
                <span class="tackice">....................................................................................................................................................................</span><br />
